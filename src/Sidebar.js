  ...
  return (
    <div style={styles.sidebar}>
      ...
      <ul style={styles.list}>
        ...
        <li>
          <button style={styles.button} onClick={() => handleNavigation('/accessible-mode')}>
            Turn On Accessible Mode
          </button>
        </li>
        <li>
        ...
        <li>
          <button style={styles.button} onClick={() => handleNavigation('/settings')}>
            Settings
          </button>
        </li>
      </ul>
